using Demo.Application.Services.Account.Commands.AddNewAccountGroup;
using Demo.Application.Services.Account.Commands.AddNewAccountLedger;
using Demo.Application.Services.Beneficiary.Commands.AddNewBenefeciary;
using Demo.Application.Services.Companies.Commands.AddNewCompany;
using Demo.Application.Services.Companies.Queries.GetCompanyBranches;
using Demo.Application.Services.Companies.Queries.GetCompanyFinancialCycle;
using Demo.Application.Services.Companies.Queries.GetCompanyUsers;
using Demo.Application.Services.CostCenter.Commands.IAddNewCostCenterService;
using Demo.Application.Services.Currencies.Queries.GetCurrencies;
using Demo.Application.Services.ExchangeRate.Queries.GetExchangeRate;
...
using Demo.Application.Services.Vouchers.JournalVoucher.Commands.AddNewJournalVoucher;
using Demo.Web.Models.Account;
using Demo.Web.Models.Benefeciary;
using Demo.Web.Models.Companies;
using Demo.Web.Models.CostCenter;
using Demo.Web.Models.Currency;
using Demo.Web.Models.ExchangeRate;
using Demo.Web.Models.Project;
using Demo.Web.Models.SuffixPrefix;
using Demo.Web.Models.Voucher;
using Demo.Web.Utilities;
using System;
using static Demo.Common.Enums;
